...
`system_generated` | User was internally created by the system
...
`system_vital_test_user_do_not_delete` | User should not be deleted as it is vital for testing or other internal systems
